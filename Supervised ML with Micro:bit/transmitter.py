...
convert the digital data into scientific data (acceleration, measured in m/s2 and transfer it to the receiver Micro:bit that is connected to the main compuetr.
"""
